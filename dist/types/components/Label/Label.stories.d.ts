...
declare const meta: {
    title: string;
    component: ({ label, action, checkLabel, color, deleteLabel, additionalClass, icon, id, isChecked, onCheck, onDelete, shape, size, ...props }: import("./Label").LabelProps) => import("react/jsx-runtime").JSX.Element;
    subcomponents: {
