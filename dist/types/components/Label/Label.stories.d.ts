...
declare const meta: {
    title: string;
    component: ({ label, transparent, action, checkLabel, color, deleteLabel, additionalClass, icon, id, isChecked, children, onCheck, onDelete, shape, size, ...props }: import("./Label").LabelProps) => import("react/jsx-runtime").JSX.Element;
    subcomponents: {
