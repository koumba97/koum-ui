...
const Label = (_a) => {
    var { label, transparent, action = 'none', checkLabel = `select ${label}`, color = 'primary', deleteLabel = `delete ${label}`, additionalClass, icon, id = label, isChecked, children, onCheck, onDelete, shape = 'round', size = 'medium' } = _a, props = __rest(_a, ["label", "transparent", "action", "checkLabel", "color", "deleteLabel", "additionalClass", "icon", "id", "isChecked", "children", "onCheck", "onDelete", "shape", "size"]);
