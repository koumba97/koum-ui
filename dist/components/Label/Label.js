...
const Label = (_a) => {
    var { label, action = 'none', checkLabel = `select ${label}`, color = 'primary', deleteLabel = `delete ${label}`, icon, id = label, isChecked, onCheck, onDelete, shape = 'round', size = 'medium' } = _a, props = __rest(_a, ["label", "action", "checkLabel", "color", "deleteLabel", "icon", "id", "isChecked", "onCheck", "onDelete", "shape", "size"]);
