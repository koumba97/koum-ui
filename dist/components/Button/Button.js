...
const Button = (_a) => {
    var { children, color = 'primary', disabled = false, shape = 'round', size = 'medium', buttonStyle = 'filled', icon, label, additionalClass, visibleLabel = true, onClick } = _a, props = __rest(_a, ["children", "color", "disabled", "shape", "size", "buttonStyle", "icon", "label", "additionalClass", "visibleLabel", "onClick"]);
